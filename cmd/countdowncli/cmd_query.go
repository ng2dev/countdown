...
`)
	...
	var (
		tmAddrFl = fl.String("tm", env("COUNTDOWNCLI_TM_ADDR", "https://countdown.NETWORK:443"),
	...
	resp, err := cl.AbciQuery(queryPath, data)
	if err != nil {
...
var queries = map[string]struct {
	...
	"/countdownUsers": {
		newObj: func() model { return &countdown.User{} },
		decKey: sequenceKey,
		encID:  numericID,
	},
	"/countdowns": {
		newObj: func() model { return &countdown.Countdown{} },
		decKey: sequenceKey,
		encID:  numericID,
	},
	"/wallets": {
