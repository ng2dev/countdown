...
// pipeline line:
//
//   $ countdowncli create-custom-state --inner-state 1 --address COUNTDOWN1hx6vjcmsgj7wgu64ajdglrhpusl3fmercl8mxe \
//       | countdowncli sign \
//       | countdowncli submit
//
...
func main() {
	if len(os.Args) == 1 {
		fmt.Fprintf(os.Stderr, "%s is a command line client for the COUNTDOWN application.\n\n", os.Args[0])
